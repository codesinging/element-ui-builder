...
class FormDialogTest extends TestCase
{
    public function testBase()
    {
        ...
        self::assertEquals(
            ...
            . PHP_EOL . '<el-button circle icon="el-icon-plus" size="small" @click="onBaseDialogZoomOutClick(\'formDialog\')" :disabled="formDialog.width>=100"></el-button>'
            . PHP_EOL . '<el-button circle icon="el-icon-minus" size="small" @click="onBaseDialogZoomInClick(\'formDialog\')" :disabled="formDialog.width<=60"></el-button>'
            . PHP_EOL . '</div>'
            . PHP_EOL . '<div>'
