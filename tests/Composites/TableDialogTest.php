...
class TableDialogTest extends TestCase
{
    public function testBase()
    {
        ...
        self::assertEquals(
            ...
            . PHP_EOL . '<el-button circle icon="el-icon-plus" size="small" @click="onBaseDialogZoomOutClick(\'tableDialog\')" :disabled="tableDialog.width>=100"></el-button>'
            . PHP_EOL . '<el-button circle icon="el-icon-minus" size="small" @click="onBaseDialogZoomInClick(\'tableDialog\')" :disabled="tableDialog.width<=60"></el-button>'
            . PHP_EOL . '</div>'
            . PHP_EOL . '<div>'
